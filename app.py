...
with st.expander("Как пользоваться фонемным поиском?"):
    st.markdown(
        ...
        **Фонемный поиск** позволяет находить слова по их звучанию, а не написанию.
        ...
        - `[тверд]` — любая твердая согласная (`б, в, г, д, ж, з, к, л, м, н, п, р, с, т, ф, х, ц, ч, ш, щ`)
        - `[мягк]` — любая мягкая согласная (`б', в', г', д', з', к', л', м', н', п', р', с', т', ф', х', ч', ш', щ`)
        - `[звонк]` — любая звонкая согласная (`б, в, г, д, ж, з, л, м, н, р, й`)
        - `[глух]` — любая глухая согласная (`п, ф, к, т, ш, с, х, ц, ч, щ`)
        - `[любой]` — любая гласная или согласная

        Также можно указать перечисление фонем в квадратных скобках:
        - `[а,о,у]` — любая из указанных гласных
        - `[б,п,в]` — любая из указанных согласных

        При поиске в режиме "в слове" можно использовать альтернацию (альтернативы):
        - `(к|с|т)а` — найдёт слова, содержащие "ка", "са", "та" и т. д.
        ...
        **Примеры запросов:**
        ...
        - `ра[гласн]` — найдет слова, начинающиеся с "ра" и далее любая гласная
